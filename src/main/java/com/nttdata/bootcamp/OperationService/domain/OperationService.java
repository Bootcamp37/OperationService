                                ...
                                .flatMap(customerPassiveProductResponse ->
                                        ...
                                        repository.findAll()
                                                ...
                                                .flatMap(count -> {
                                                  ...
                                                  if(!Objects.isNull(customerPassiveProductResponse.getMovementLimit())) {
                                                  ...
                                                  // log.info(" 2.0 Here  ===> " + Objects.isNull(customerPassiveProductResponse.getMaxMovementFree()));
                                                  ...
                                                  if(Objects.isNull(customerPassiveProductResponse.getMaxMovementFree())) {
                                                    commission = 0.0;
                                                    log.info(" 2.1 Here  ===> " + commission.toString());
                                                  }
                                                  else if (count.compareTo(Long.valueOf(customerPassiveProductResponse.getMaxMovementFree())) >= 0) {
